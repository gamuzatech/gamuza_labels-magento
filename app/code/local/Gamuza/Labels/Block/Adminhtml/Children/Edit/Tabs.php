...
class Gamuza_Labels_Block_Adminhtml_Children_Edit_Tabs
extends Mage_Adminhtml_Block_Widget_Tabs
{
	...
	protected function _beforeToHtml()
	{
		...
		"content" => $this->getLayout()->createBlock("labels/adminhtml_children_edit_tab_form")->toHtml(),
		));
